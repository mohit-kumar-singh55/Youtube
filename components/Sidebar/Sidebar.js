...
import { CashIcon, ColorSwatchIcon, CubeTransparentIcon, DesktopComputerIcon, DocumentDuplicateIcon, DuplicateIcon, HomeIcon, LibraryIcon, RefreshIcon } from "@heroicons/react/solid";
...
const Sidebar = () => {
    ...
    return (
        <aside className='w-[250px] bg-[#202020] h-screen overflow-y-scroll flex items-center justify-start flex-col gap-1'>
            {/* section */}
